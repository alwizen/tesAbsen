{{-- resources/views/payroll/bulk-slip.blade.php --}}
<!DOCTYPE html>
<html lang="id">

<head>
    <meta charset="UTF-8" />
    <title>Bulk Slip Gaji</title>
    ...
    <style>
        * {
        ...
        .slip-wrapper {
            ...
            padding: 8px 12px;
            /* page-break-after applied dynamically via class */
        }
...
<body>
    ...
    {{-- Tombol print --}}
    <div class="no-print">
        <button onclick="window.print()">Cetak / Simpan PDF Semua Terpilih</button>
    </div>

    @foreach($details as $index => $detail)
        @php
        $employee = $detail->employee;
        $department = $employee->department ?? new \App\Models\Department();
